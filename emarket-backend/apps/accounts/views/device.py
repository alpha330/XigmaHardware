...
class DeviceViewSet(mixins.ListModelMixin,        # ✅ اضافه کردن ListModelMixin
                    mixins.RetrieveModelMixin,     # ✅ اضافه کردن RetrieveModelMixin
    ...
    - revoke_all_other: لغو همه دستگاه‌های دیگر
    """
    ...
    def get_permissions(self):
        ...
        """
        if self.action in ['my_devices', 'trust_device', 'revoke_device', 'revoke_all_other']:
    ...
    # ✅ حالا list و retrieve از mixins میان
